...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:php='remove'>
    ...
    <xsl:variable name="opening_node_img_name"
                  select="/treeview/custom-parameters/param[@name='opening_node_img_name']/@value"/>
    <xsl:variable name="closing_node_img_name"
                  select="/treeview/custom-parameters/param[@name='closing_node_img_name']/@value"/>
    <xsl:variable name="leaf_node_img_name"
                  select="/treeview/custom-parameters/param[@name='leaf_node_img_name']/@value"/>
    <xsl:variable name="modal_dialog_mode"
                  select="/treeview/custom-parameters/param[@name='modal_dialog_mode']/@value"/>
    ...
    <xsl:template match="folder">
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            <tr id="str_obj">
                ...
                <xsl:attribute name="item_code">
                    <xsl:value-of select="@value"/>
                </xsl:attribute>
                <xsl:attribute name="item_title">
                    ...
                    <xsl:if test="$show_control='true'">
                        <xsl:if test="$type='1'"> <!--Neu la leaf object-->
                            <xsl:element name="input">
                                ...
                                <xsl:attribute name="xml_tag_in_db_name">
                                    <xsl:value-of select="@xml_tag_in_db_name"/>
                                </xsl:attribute>
                                <xsl:attribute name="select_parent">
                                    <xsl:value-of select="@select_parent"/>
                                </xsl:attribute>
                ...
                <td valign="top" align="left" colspan="3">
                    <a onclick="node_image_onclick(this,'{$show_control}','{$opening_node_img_name}','{$closing_node_img_name}',document.getElementById('hdn_list_parent_id'))"
                       class="folder">
