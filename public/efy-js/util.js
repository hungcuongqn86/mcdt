...
function FormatHour(txt_obj, separator_char){
	...
	if (theLen>=2) {
		...
		if(theHour >= 24){alert("Bạn nhập gi�? không đúng (Gi�? phải nh�? hơn 24)");txt_obj.value = '';return;}

		theMinute = theStr.substring(2);
		if(theMinute > 59){alert("Bạn nhập phút không đúng (phút phải nh�? hơn 60)"); txt_obj.value = '';return;}
