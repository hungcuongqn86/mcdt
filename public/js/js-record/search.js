...
record_search.prototype.loadheader = function (mode) {
    ...
    var html = '<table cellpadding="0" cellspacing="0" border="0" width="99%" align="center" class="list_table2" id="table1"><colgroup><col width="3%"><col width="26%"><col width="8%"><col width="6%"><col width="6%"><col width="5%"><col width="5%"><col width="5%"><col width="5%"><col width="5%"><col width="5%"><col width="5%"><col width="5%"><col width="5%"><col width="5%"></colgroup>';
        html +='<THEAD><tr class="round_row"><td class="normal_label" rowspan="4" align="center" style="font-weight:bold;">STT</td><td class="normal_label" rowspan="4" align="center" style="font-weight:bold;">'+b+'</td><td class="normal_label" colspan="3" align="center" style="font-weight:bold;">Tổng hồ sơ nhận giải quyết</td><td class="normal_label" colspan="10" align="center" style="font-weight:bold;">Kết quả giải quyết</td></tr>';
        ...
        html +='<tr class="odd_row"><td class="normal_label" align="center" style="font-size: 10px;font-style:italic">A</td> <td class="normal_label" align="center" style="font-size: 10px;font-style:italic">B</td> <td class="normal_label" align="center" style="font-size: 10px;font-style:italic">(1)=2+3</td> <td class="normal_label" align="center" style="font-size: 10px;font-style:italic">(2)</td> <td class="normal_label" align="center" style="font-size: 10px;font-style:italic">(3)</td> <td class="normal_label" align="center" style="font-size: 10px;font-style:italic">(4)=5+7</td> <td class="normal_label" align="center" style="font-size: 10px;font-style:italic">(5)</td> <td class="normal_label" align="center" style="font-size: 10px;font-style:italic">(6)=5/4</td> <td class="normal_label" align="center" style="font-size: 10px;font-style:italic">(7)</td> <td class="normal_label" align="center" style="font-size: 10px;font-style:italic">(8)=7/4</td> <td class="normal_label" align="center" style="font-size: 10px;font-style:italic">(9)=10+12</td> <td class="normal_label" align="center" style="font-size: 10px;font-style:italic">(10)</td> <td class="normal_label" align="center" style="font-size: 10px;font-style:italic">(11)=10/9</td> <td class="normal_label" align="center" style="font-size: 10px;font-style:italic">(12)</td> <td class="normal_label" align="center" style="font-size: 10px;font-style:italic">(13)=12/10</td> </tr>';
...
record_search.prototype.generalMatrix = function (arrResult,mode) {
    ...
    html = '';
    var classtr = "odd_row";
    var t1= 0,t2= 0,t3= 0,t4= 0,t5= 0,t7= 0,t9= 0,t10 = 0,t12=0;
    $.each(arrResult, function(i, item) {
        if(classtr == 'odd_row'){
            classtr = "round_row";
        }else{
