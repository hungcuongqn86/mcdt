...
class record_wreceiveController extends  Zend_Controller_Action {
    ...
    public function printotherreceiptAction(){
        ...
        //Print Receipt
        $sReceiptContentFile = $objQLDTFun->ecs_printTempDoc('./xml/record/' . $arrGetSingleRecord['C_KEY'].'/' . $psFileName.'.xml', 'replace_list', 'replace', '', $psXmlStr, $arrGetSingleRecord,'./templates/' . $arrGetSingleRecord['C_KEY'] . '/',$psFileName.'.docx',$sOwnerCode);
